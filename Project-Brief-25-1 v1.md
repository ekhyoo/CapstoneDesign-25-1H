...
| (7) 과제 내용 요약 | [한 줄 소개] <br> 본 프로젝트는 귀국 후 남은 외화를 근처 사용자와 연결해 수수료 없이 직접 환전할 수 있도록 지원하는 AI 기반 스마트 외화 직거래 서비스입니다. <br> <br><br>[Pain Point] <br> 1. 은행 환전은 시간적 접근성이 낮습니다. <br>은행을 통한 지폐 환전은 평일 낮 영업시간 내에만 가능합니다. <br> 2. 소액 외화는 사실상 환전이 불가능합니다. <br> 특히 동전은 대부분의 환전소에서 취급하지 않기에 결국 많은 동전들은 가치를 잃은 채 집에 방치됩니다. <br> 3. 외화 종류와 가치를 파악하기 어렵습니다. <br> 국가마다 디자인과 단위가 달라 구별이 어렵고, 원화로 환산된 외화의 가치를 알기 힘듭니다. <br><br> [타겟 사용자]<br> 1. 여행 후 동전이 남았지만 처리하지 못한 사람 <br> 2. 은행 시간에 맞춰 환전하러 가기 번거로운 직장인/학생 <br> 3. 여러 나라 돈을 섞어두고 무엇인지 모른 채 방치한 사람 <br>|
