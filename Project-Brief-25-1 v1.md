...
|:---  |---  |
| (2) 팀 번호/이름 | 38-상상그이상 |
| (3) 구성원 | 김연수(2176077): 리더, BE <br> 방민지(2076180): AI 기능 정의 및 기술 스택 선정, RAG 파이프라인 설계, AI 모델 개발 및 튜닝, LangChain 모듈 구성 및 최적화 <br> 이서연(2271045): UI 디자인, 기능 정의, 화면 구성 설계, 컴포넌트 구조 설계, 데이터 요청 및 응답 처리, 코드 테스트 및 문서화 |
| (4) 지도교수 | 오세은 교수 |
| (5) 트랙  | 산학 |
| (6) 과제 키워드 | 실시간 채팅형 독서모임, AI 진행자, GPT-4o |
| (7) 과제 내용 요약 |  <br>**[한 줄 소개]**<br>&nbsp;Modam은 AI 진행자가 이끄는 실시간 채팅 기반의 온라인 독서 모임 서비스로, 대면이 어려운 독서 애호가들이 시간과 장소에 구애받지 않고 효율적으로 모임에 참여할 수 있도록 돕습니다.<br><br>**[Pain Point]**<br>&nbsp;최근 젊은 층을 중심으로 독서율이 증가하고 독서가 하나의 문화 트렌드로 자리잡고 있지만, 이를 지속적으로 이어갈 수 있는 환경은 부족합니다. 학업이나 과제, 지역적 거리 등 시간적·물리적 제약으로 오프라인 독서 모임 참여가 어려운 경우가 많고, 대면 토론에 대한 심리적 부담도 작지 않습니다. 특히 마이너 장르 도서를 좋아하는 사람들은 취향이 맞는 참여자를 찾기 어려워 모임 자체가 성사되기 힘들며, 모임을 주최하거나 운영하는 데 부담을 느끼는 경우도 많습니다. 또한, 토론 이후 내용을 구조화하거나 정리하는 데 어려움을 느끼며, 회의처럼 요약된 결과물을 바라는 수요가 존재합니다. 온라인 환경에서는 자유로운 의견 표현을 기대하면서도, 익명 채팅에서 발생할 수 있는 비속어나 혐오 표현에 대한 불안감이 여전히 존재합니다. 이러한 pain point를 해결하기 위한 solution으로 modam을 기획하게 되었습니다.<br><br>**[Target Customer]**<br>&nbsp;1. 독서를 좋아하지만 시간적·물리적 제약으로 오프라인 모임 참여가 어려운 사람<br>&nbsp;2. 낯선 사람과의 대면 토론에 심리적 부담을 느끼며, 익명 기반의 온라인 소통을 선호하는 경향이 있는 사람<br>&nbsp;3. 모임 운영이나 발제문 작성에는 부담을 느끼고, 독서 내용을 정리하거나 구조화하는 데 익숙하지 않은 사람<br>&nbsp;4.실용적이거나 깊이 있는 독서를 선호하며, 자신과 관심사가 맞는 사람들과의 의미 있는 소통을 원하는 사람<br>&nbsp;5. 자유롭고 안전한 환경에서 효율적으로 독서 토론에 참여하고 싶은 사람<br><br>**[주요 기능]**<br>&nbsp;1. 독서 모임 참여자들과 AI 사회자가 소통할 수 있는 실시간 채팅<br>&nbsp;2. 책 내용과 사용자의 독후감을 기반으로 하는 발제문 자동 생성<br>&nbsp;3. 비속어, 혐오 표현 등의 부적절한 발언을 자동 필터링<br>&nbsp;4. 독서 모임 내용을 자동 요약, 저장<br><br>**[기대 효과]**<br>&nbsp;1. 성별, 나이, 직업, 외모 등 다양한 개인 정보가 독서모임의 분위기에 영향을 미치지 않고 배제되어 오로지 책과 토의 주제에만 집중할 수 있습니다.<br>&nbsp;2. 상대방의 배경에 관계없이 자신의 의견을 표현하며 넓은 시야로 자유롭게 모임에 참여할 수 있습니다.<br>&nbsp;3.  공간적 제약이 사라짐에 따라 다양한 지역의 사람들이 모여 풍부한 경험과 관점을 공유할 수 있습니다.<br>&nbsp;4. AI가 모임을 효율적으로 관리함으로써 사용자는 모임 준비와 진행에 대한 부담을 덜고, 더 많은 사람들이 모임을 주최할 수 있는 기회를 얻게 됩니다.<br>&nbsp;5. AI가 발제문을 생성하고 모임을 관리하며, 요약까지 제공해주기 때문에 토론의 질과 효율성이 높아집니다.|
