...
| (7) 과제 내용 요약 | **[한줄소개]**<br>하우키키는 고객의 다양한 요구에 유연하게 대응하고, 주문부터 결제까지 자동화하는 AI 챗오더 서비스입니다.<br><br>**[타겟고객 & 페인포인트]**<br>**고객은** 기존의 키오스트나 테이블 오더를 통해서 다양한 요구나 문의를 해결하기 어렵습니다.<br>**1인 사장님은** 주문 외 문의를 자동으로 처리할 수 없어 직접 응대해야 하는 부담이 있습니다.<br><br>**[주요기능]**<br>- **대화형 주문 생성**:<br>고객이 챗오더와 자연스럽게 대화하며 주문하면, 챗오더는 이를 인지하여 주문을 생성하고 결제까지 자동으로 처리합니다. 대화는 고객 상황과 매장 특성에 맞게 최적화됩니다.<br>- **실시간 주문 &요청 사항 알림 기능**:<br>고객의 주문 및 요청이 발생하면 관리자 화면에 실시간으로 알림이 전달되고, 사장님은 즉시 확인할 수 있습니다. 사장님이 주문 취소할 경우, 고객에게 취소 사유가 포함된 알림이 전송됩니다.<br><br>**[기대효과]**<br>- 매장 고객 응대 및 직원 고용 부담을 줄일 수 있도록 **한 명의 직원과 같은 서비스** 제공합니다.<br>- 챗오더와의 대화를 통해 **사용자의 다양한 요구와 질문에 즉각 대응**하여 **매장 이용 만족도 향상**됩니다.  |
