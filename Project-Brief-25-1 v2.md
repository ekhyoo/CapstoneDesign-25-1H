...
|:---  |---  |
| (2) 팀 번호/이름 | 38-상상그이상 |
| (3) 구성원 | 김연수(2176077): 리더, 백엔드 API 설계 및 개발, DB 모델링 및 쿼리 최적화, 실시간 채팅 기능 구현, AI 서버 연동, 컨테이너화 및 배포(Docker) <br> 방민지(2076180): AI 기능 정의 및 기술 스택 선정, RAG 파이프라인 설계, AI 모델 개발 및 튜닝, LangChain 모듈 구성 및 최적화 <br> 이서연(2271045): UI 디자인, 기능 정의, 화면 구성 설계, 컴포넌트 구조 설계, 데이터 요청 및 응답 처리, 코드 테스트 및 문서화 |
| (4) 지도교수 | 오세은 교수 |
| (5) 트랙  | 산학 |
