...
| 항목 | 내용 |
|:---|---|
| (1) 문제 정의 | *현대 공포 게임은 주로 시청각 자극에 의존하며, 예측 가능성과 반복성으로 인해 몰입도를 저하시킨다. 특히 멀티플레이 공포 게임은 플레이어 간 상호작용이 제한적이며, 심리적 공포보다는 외부 자극 중심이다. 본 프로젝트는 AI 음성 기술(STT, LLM, TTS, Voice Cloning)을 통해 몬스터가 플레이어의 목소리를 모방하고, 이를 기반으로 플레이어 간 신뢰와 의심 사이의 긴장을 유도해 새로운 심리적 공포 경험을 제공하고자 한다.* |
